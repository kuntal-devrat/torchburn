//! Per-tensor / per-channel quantization and dequantization.
//!
//! INT8/INT32 quantize, dequantize, INT8 GEMM, NF4/INT4
//! dequantize. Inherits root imports via super; pure move.
