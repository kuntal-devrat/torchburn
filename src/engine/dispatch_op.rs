...
static TARGET_MODULE_PAIRS: &[(&str, usize)] = &[
    ...
    ("gelu_backward", M_ELEMENTWISE),
    ("silu_backward", M_ELEMENTWISE),
    ("sigmoid_backward", M_ELEMENTWISE),
    ("tanh_backward", M_ELEMENTWISE),
    ("leaky_relu_backward", M_ELEMENTWISE),
